...
↑ Тобто ми робимо подвійну перевірку... Якщо логін користувача не співпадає з 'Bobik' то доступу немає, якщо логін користувача 'Bobik' перевіряється умова з права і якщо пароль не відповідає 'qwerty'  у доступі відхилено.
----------------------------------------
...
нагадаємо собі як працює оператор % - він показує скільки лишається якщо перший операнд поділити на другий. наприклад 9 % 3 = 0 бо ми якщо розділити 9 на 3 ми ідеально ділимо його на 3 частини не маючи залишку, а от якщо ми 10 ділимо на 3 то при 10 % 3 ми отримаємо 1, бо 10 не можна поділити ідеально без залишку, залишком буде 1. 12 % 3 = 0. Бо 12 кратне 3.
...
↑ Якщо поточний час більше ніж 9 тобто години відкриття, ТА меньше 18 - години закритта ТА сьогодні не вихідний день, тоді магазин відчинений. Тут використовуємо два оператори І та оператор заперечення, щоб підкрислити в умові що це НЕ є вихідним днем.
`
const or = `
