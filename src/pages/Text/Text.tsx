...
const Text: React.FC = () => {
  return (
   <div className='container'>
          ...
          <p className='description'>Існує ряд тегів, який допомагає стилізувати текст без участі CSS. Загалом це архвїчні елементи, використання яких стало  не доцільним та не рекомендованим за появи та розвитку каскадних таблиць стилів - CSS.</p>
