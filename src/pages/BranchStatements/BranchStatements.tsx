...
const [age, setAge] = useState<string>(''); // Стан для віку, зберігається як рядок
  ...
  return (
    <div className='container'>
      ...
      <div>
        <h3>Switch()</h3>
        <p>За допомогою світча ми можемо прописати декілька сценаріїв взалежності від значення однієї змінної. Тут на прикладі залежності від дня тижня ми побачимо в консолі відповідне повідомлення. </p>
        <div className="input">
